StippleUI.layout(view = "hHh Lpr lff",
    [
        ...
        drawer(bordered = "", fieldname = "left_drawer_open", side = "left",
            ...
            width = "170", breakpoint = 200, class = "bg-black",
            ...
            Html.div(class = "", @iif("selected_page == 'chat'"),
                [
                    textfield("Enter your question here...", :question,
                        @on("keyup.enter",
                            "submit = !submit")),
                    cell(class = "flex",
                        [
                ...
                [
                    ...
                    cell([
                        ...
                        select(:packs, options = :packs_options,
                            label = "Packs", clearable = true,
                            multiple = true, usechips = true)
                    ])
                ])
        ])
    ]
